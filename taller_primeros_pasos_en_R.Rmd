...
### Modificado por Laura Ación (original de [Riva Quiroga](https://twitter.com/rivaquiroga), [R-Ladies Santiago, Chile](https://www.meetup.com/rladies-scl/))

El objetivo de este Taller es acompañar a principiantes en el proceso que va desde la instalación de R a la manipulación inicial de datos. 
...
El tutorial contiene imágenes, con el fin de ir ilustrando el proceso tal como debería verse en tu computadora.
...
### IMPORTANTE
Es esencial que todo el procedimiento de instalación se haga antes de concurrir en forma presencial al Curso de Nivelación. Caso contrario, es posible que no puedas practicar en tu computadora los pasos que siguen durante el curso.
...
<a href="url"><img src="https://github.com/lauracion/R_Curso_de_Nivelacion/blob/master/images/rstudio_icono.png" align="center" width="12%"></a>
...
```
<a href="url"><img src="https://github.com/lauracion/R_Curso_de_Nivelaciono/blob/master/images/summarize_arya.png" align="center" width="75%"></a>
...
¡Hay mucho más que aprender! Por ejemplo, a modo de curiosidad, agrego que este texto se ha generado desde RStudio.
